...
describe InspirationsController do
  ...
  # InspirationsController. Be sure to keep this updated too.
  def valid_session
    {}
  end
  ...
  describe "GET show" do
    it "assigns the requested inspiration as @inspiration" do
      inspiration = Inspiration.create! valid_attributes
      get :show, {:id => inspiration.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested inspiration as @inspiration" do
      inspiration = Inspiration.create! valid_attributes
      get :edit, {:id => inspiration.to_param}, valid_session
      assigns(:inspiration).should eq(inspiration)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Inspiration" do
        expect {
          post :create, {:inspiration => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved inspiration as @inspiration" do
        ...
        post :create, {:inspiration => {}}, valid_session
        assigns(:inspiration).should be_a_new(Inspiration)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested inspiration" do
        ...
        put :update, {:id => inspiration.to_param, :inspiration => {'these' => 'params'}}, valid_session
      end

      it "assigns the requested inspiration as @inspiration" do
        inspiration = Inspiration.create! valid_attributes
        put :update, {:id => inspiration.to_param, :inspiration => valid_attributes}, valid_session
        assigns(:inspiration).should eq(inspiration)
      end
    ...
    describe "with invalid params" do
      it "assigns the inspiration as @inspiration" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Inspiration.any_instance.stub(:save).and_return(false)
        put :update, {:id => inspiration.to_param, :inspiration => {}}, valid_session
        assigns(:inspiration).should eq(inspiration)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested inspiration" do
      inspiration = Inspiration.create! valid_attributes
      expect {
        delete :destroy, {:id => inspiration.to_param}, valid_session
      }.to change(Inspiration, :count).by(-1)
    end
